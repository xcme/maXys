...
* Уведомление в конференцию jabber об заранее определенных событиях
* Определение коммутатора по ID из базы данных, что позволяет сохранять историю коммутатора даже при смене его IP-адреса
